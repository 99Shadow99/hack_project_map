    ...
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      <div style={{
        ...
        <button
          ...
          onClick={() => {
            // Add test population
            populationGrid.addPerson(23.1821, 75.7890, 5);
            populationGrid.addPerson(23.1822, 75.7891, 8);
            populationGrid.addPerson(23.1823, 75.7892, 12);
            setPopulatedAreas(populationGrid.getPopulatedAreas());
            setDebugInfo('🧪 Added test crowds');
          }}
        >
          🧪 Add Test Crowds
        </button>
